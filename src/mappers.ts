import { Message, MessageBehavior, TextAttributes, TextEntity, Thread } from '@textshq/platform-sdk'
...
export function mapThread(conv: any, currentUserID: string): Thread {
  return {
